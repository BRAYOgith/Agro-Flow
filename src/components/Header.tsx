    ...
    <header className="h-16 bg-white border-b border-[#dae2fd] px-6 flex items-center justify-between sticky top-0 z-10 shadow-xs">
      ...
      <div className="flex items-center gap-4">
        <div className="relative w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-8 py-1.5 text-xs bg-[#f2f3ff] text-[#131b2e] border border-[#c0c9be]/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#006a61] focus:bg-white transition-all placeholder:text-gray-400"
          />
          {searchQuery && (
            <button
        ...
        {weatherData.temp !== null && (
          <div className="hidden lg:flex items-center gap-2 bg-[#eaedff] px-3 py-1.5 rounded-lg border border-[#dae2fd] text-xs font-medium text-[#131b2e]">
            <span className="material-symbols-outlined text-[#006a61] text-base">cloud</span>
            <span>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 pl-2 border-l border-gray-200">
          <div className="w-8 h-8 rounded-full bg-[#003b1b] text-white flex items-center justify-center font-bold text-xs">
            JM
          </div>

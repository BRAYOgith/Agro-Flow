...
In Next.js 15 with the App Router, structured data is rendered server-side. There is no `react-helmet-async`, so use native script tags with `JSON.stringify` on static schema objects instead.
...
| FAQPage | If FAQ exists | If FAQ exists | N/A | N/A | If FAQ exists | If FAQ exists |
| LocalBusiness | If physical | N/A | N/A | N/A | N/A | If physical |
| Article | If blog | N/A | Required | N/A | N/A | N/A |
| Event | If events | N/A | N/A | If speaking | N/A | N/A |
| VideoObject | If video | If video | If video | N/A | N/A | N/A |
| SoftwareApplication | N/A | Required | N/A | N/A | N/A | N/A |
| Course | N/A | If LMS | N/A | N/A | N/A | N/A |
| ProfilePage | N/A | N/A | Author pages | Homepage | N/A | N/A |
| Product | N/A | SaaS pricing | N/A | N/A | N/A | Required |
...
> Not a separate Google gallery item but widely recommended: it powers the sitelinks search box.
...
> **Note**: Only include `aggregateRating` if you have genuine, verifiable ratings. Don't fabricate ratings: it violates Google's guidelines.
